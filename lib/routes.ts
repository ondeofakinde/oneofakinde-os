...
export const routes = {
  ...
  townhallGallery: (): Route => asRoute("/townhall/gallery"),
  ...
  galleryHub: (): Route => asRoute("/gallery"),
  ...
  dropPreviewPhotos: (dropId: string): Route => asRoute(`/drops/${dropId}/preview/gallery`),
  ...
  dropPhotos: (dropId: string): Route => asRoute(`/drops/${dropId}/gallery`),
